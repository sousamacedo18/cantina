 ...
 * @author Home
 */
public class TimeLineEditarDialog extends javax.swing.JDialog {
...
public int idtimeline=0;
     ...
     */
    public TimeLineEditarDialog(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        return false;
         ...
         public void editarCampos(Integer id){
               ...
               for (TimeLineController u : dao.CarregarTimeLineId(id)) {
                    ...
                    sltStatus.setSelectedIndex(u.getStatusTimeLine());
                    idtimeline=id;
            }
         }
...
//        time.setIdTimeLineAluno(Integer.parseInt(txtIdAluno.getText()));
        ...
        time.setIdTimeLine(idtimeline);
//        time.setIdUsuarioTimeLine(idUsuario);
        TimeLineDao dao = new TimeLineDao();
        dao.AtualizarTimeLine(time);   
        this.dispose();
        setRetorno(1);
    ...
    private void initComponents() {
        ...
        lbTitulo1.setText("Alterar Time Line de Estudante");
                ...
                .addGroup(JP_PRINCIPALLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(JP_PRINCIPALLayout.createSequentialGroup()
                        .addGroup(JP_PRINCIPALLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtNomeAluno, javax.swing.GroupLayout.PREFERRED_SIZE, 458, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TimeLineEditarDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TimeLineEditarDialog dialog = new TimeLineEditarDialog(new javax.swing.JDialog(), true);
