 ...
 * @author Home
 */
public class TrocarSenhaAdm extends javax.swing.JDialog {
...
private String senhanova;
     ...
     */
    public TrocarSenhaAdm(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
   ...
   public void setarSenhaAtual(int id) throws SQLException{
    ...
    try {
        ...
        Logger.getLogger(TrocarSenhaAdm.class.getName()).log(Level.SEVERE, null, ex);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TrocarSenhaAdm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TrocarSenhaAdm dialog = new TrocarSenhaAdm(new javax.swing.JDialog(), true);
