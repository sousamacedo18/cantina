 ...
 * @author Home
 */
public class PesquisaAlunoForm extends javax.swing.JDialog {
private int id;
private String nome="";
     ...
     */
    public PesquisaAlunoForm(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        carregarTudo();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisaAlunoForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PesquisaAlunoForm dialog = new PesquisaAlunoForm(new javax.swing.JDialog(), true);
