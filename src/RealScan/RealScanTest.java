...
public class RealScanTest extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        selectMode.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Disabled", "Roll", "Flat One", "Flat Two", "Flat Four(Left)", "Flat Four(Right)", "palm(Left)", "palm(Right)", "Flat One(Ex)", "Flat Two(Ex)", "Custom(Flat)" }));
        ...
        sensitivity.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "High", "Higher", "Disabled" }));
    ...
    {
        if(nNumOfTargetFingers + nFingerCount <= 10 && nSlapType < RealScan_JNI.RS_SLAP_ONE_FINGER)
        {
            ...
            for(int i=0; i< nNumOfTargets; i++)
            {
                ...
                {
                    //System.arraycopy(imgByte, 0, bSeqCheckTargetImages[i], 0, imageWidth*imageHeight);
                    bSeqCheckTargetImages[i] = imgByte;
                    nSeqCheckTargetWidths[i] = imageWidth;
                    nSeqCheckTargetHeights[i] = imageHeight;
                    bIsOverlapped = true;
                    break;
                }
            }
